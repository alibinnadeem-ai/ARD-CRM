/**
 * pages/signup.jsx
 * Standalone signup page (no sidebar layout).
 */
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: 22, fontWeight: 700, color: "var(--brand-primary, #1a3a5c)", marginBottom: 6 }}>Create account</h1>
        <p style={{ color: "var(--text-muted, #888)", fontSize: 13.5, marginBottom: 24 }}>Sign up to start using the CRM</p>
        ...
        <div style={{ marginTop: 20, textAlign: "center", fontSize: 13, color: "var(--text-muted, #888)" }}>
          ...
          <Link href="/login" style={{ color: "var(--brand-accent, #e8633a)", fontWeight: 600, textDecoration: "none" }}>
            Sign in
          </Link>
        </div>
      </div>
